...
global grad_z1, grad_h1, grad_z2, grad_h2, grad_o
...
grad_z1 resq 128 ; gradient for z1
grad_h1 resq 128 ; gradient for h1
grad_z2 resq 64  ; gradient for z2
grad_h2 resq 64  ; gradient for h2
